  ...
  return (
    <>
      <section>
          ...
          <div className="md1000:w-[60%] md1000:flex md1000:flex-col md1000:mx-auto min800:w-[90%] min620:w-full">
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-y-20 min620:grid-cols-1 min620:mx-auto">
              <div className="flex flex-col relative">
                ...
                Nathani Heights Commercial Wings A, Lamington Rd, 
                <br/>Mumbai Central Maharashtra India 400008
        ...
        {/* map */}
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d482643.4351155743!2d72.7633931!3d19.0790394!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1697203732176!5m2!1sen!2sin"
          allowFullScreen=""
          loading="lazy"
          samesite="Strict"
          title="map"
